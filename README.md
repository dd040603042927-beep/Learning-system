...
这是一个以“用户自定义目标”为中心的个人学习管理系统。v2 不再把系统底层固定为“考研 + 就业”双路线，而是让用户先定义自己的学习目标，再把笔记、计划、复习、总结和 AI 建议都关联到目标上。
...
- 目标优先级：根据重要程度、截止紧急度、低掌握笔记、到期复习、延期计划和停滞时间计算优先级分数。
- 目标关联：笔记、知识点、学习计划、复习提醒和周总结都可以关联目标。
